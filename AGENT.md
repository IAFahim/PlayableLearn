This is a fantastic challenge. The **Playable API** is the underlying engine of Unity's animation and Timeline systems. It is raw, fast, and completely decoupled from GameObjects—perfect for our **Data-Oriented** philosophy.

Most tutorials make this boring ("Here is how to play a clip"). We will make it engineering art. We will build a **living engine** from scratch, bit by bit.

Here is the **"Performance by Structure" 100-Day Curriculum**, broken into 10-day "Sprints."
...
*   **Day 01:** The Empty Graph. (Creating/Destroying the `PlayableGraph`).
