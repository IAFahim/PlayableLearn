...
namespace Timeline.Samples
{
    ...
    [Serializable]
    [CreateAssetMenu(fileName = nameof(TimeDilationPlayableAsset),
        menuName = nameof(PlayableAsset) + "/" + nameof(TimeDilationPlayableAsset))]
    public class TimeDilationPlayableAsset : PlayableAsset, ITimelineClipAsset
    {
        ...
        // to be animated.
        [NoFoldOut] public TimeDilationBehaviour template = new TimeDilationBehaviour();
